...
namespace MySql.Data.Entity
{
  abstract class SqlGenerator : DbExpressionVisitor<SqlFragment>
  {
    ...
    protected internal void VisitAndReplaceTableName(SqlFragment sf, string oldTable, string newTable)
    {
      ...
      LiteralFragment literalFragment = sf as LiteralFragment;
      if (bf != null)
      {
      ...
      else if (literalFragment != null)
      {
        literalFragment.Literal = literalFragment.Literal.Replace("`" + oldTable + "`", "`" + newTable + "`");
      }
    }
